...
class ConfidenceNet(nn.Module):
    def __init__(self):
        ...
        # self.fc1 = nn.Linear(10, 10)  # 3*10: 4 sec, 3*20: 600 sec, 4*10: 476 sec
        # self.fc2 = nn.Linear(10, 10)
        # self.fc3 = nn.Linear(10, 10)
        self.fc_output = nn.Linear(10, 43)
...
def main():
    ...
    if args.save_model:
        save_net = "../../networks/gtsrb/gtsrb_confidence_fc_exp" + str(args.seed)
