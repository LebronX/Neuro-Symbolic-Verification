...
class EqNet(nn.Module):
    def __init__(self):
        ...
        self.fc_input = nn.Linear(resize * resize, 35)
        self.fc1 = nn.Linear(35, 35)  # 3*10: 4 sec
        self.fc2 = nn.Linear(35, 35)
        # self.fc3 = nn.Linear(35, 35)
        self.fc_output = nn.Linear(35, 43)

        self.fc_input_prop = nn.Linear(resize * resize, 35)
        self.fc1_prop = nn.Linear(35, 35)  # 3 * 10 for hidden layers
        self.fc2_prop = nn.Linear(35, 35)
        # self.fc3_prop = nn.Linear(35, 35)
        self.fc_output_prop = nn.Linear(35, 43)
...
def main():
    ...
    if args.save_model:
        ...
        save_net = "../../networks/gtsrb/gtsrb_eq_fc_exp" + str(args.seed)
